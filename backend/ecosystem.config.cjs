  ...
  apps: [
    {
      ...
      cwd: __dirname,
      script: '/bin/bash',
      args: ['-lc', 'exec node --max-old-space-size=4096 --import tsx/esm src/cli/index.ts sync-hourly --run-immediately'],
      instances: 1,
      exec_mode: 'fork',
      autorestart: true,
    ...
    },
    {
      ...
      cwd: __dirname,
      script: '/bin/bash',
      args: ['-lc', 'exec node --max-old-space-size=4096 --import tsx/esm src/cli/index.ts repair-user-vote-stats --social-only'],
      instances: 1,
      exec_mode: 'fork',
      autorestart: false,
      cron_restart: '30 4 * * 1',
